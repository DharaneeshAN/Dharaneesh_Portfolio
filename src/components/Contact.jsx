...
const Contact = () => {
  ...
  const contactInfo = [
    ...
    { icon: <FiMail className="text-xl" />, title: 'Email', details: 'dharaneeshdharaneesh417@gmail.com' },
    { icon: <FiPhone className="text-xl" />, title: 'Phone', details: '+91 7871803138' },
  ];

  const socialLinks = [
    { icon: <FiLinkedin className="text-xl" />, url: 'https://www.linkedin.com/in/dharaneesh-a-n-b43570259/', label: 'LinkedIn' },
    { icon: <FiGithub className="text-xl" />, url: 'https://github.com/DharaneeshAN', label: 'GitHub' },
    { icon: <FiInstagram className="text-xl" />, url: 'https://www.instagram.com/dharanezzz/', label: 'Instagram' },
  ];
          ...
          >
            <div className="space-y-8">
              ...
              >
                ...
                >
                  dharaneeshdharaneesh417@gmail.com
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
