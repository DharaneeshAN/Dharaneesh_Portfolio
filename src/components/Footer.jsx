  ...
  const socialLinks = [
    {
      ...
      url: 'https://www.linkedin.com/in/dharaneesh-a-n-b43570259/',
      label: 'LinkedIn',
    ...
    },
    {
      ...
      url: 'https://www.instagram.com/dharanezzz/',
      label: 'Instagram',
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col items-center">
          ...
          >
            ...
            <p className="text-gray-400 text-sm mt-1">UI/UX and AR/VR</p>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-500 text-xs">© {year} Dharaneesh . All Rights Reserved.</p>
