...
import { FaEnvelope, FaGithub, FaLinkedin,FaInstagram , FaTwitter, FaSun, FaMoon, FaChevronDown, FaGraduationCap, FaProjectDiagram, FaLaptopCode, FaRocket, FaDownload, FaShareAlt } from 'react-icons/fa';
...
const About = () => {
  ...
  const skills = [
    { name: 'Unity', icon: <FaLaptopCode />, description: 'Developing AR/VR projects and immersive games using Unity and C#.' },
    { name: 'Blender', icon: <FaLaptopCode />, description: 'Creating 3D models and assets for interactive applications.' },
    { name: 'Figma', icon: <FaLaptopCode />, description: 'Designing UI/UX wireframes and prototypes with Figma.' },
    { name: 'Python', icon: <FaLaptopCode />, description: 'Writing programs and solving problems using Python.' },
    { name: 'C++', icon: <FaLaptopCode />, description: 'Implementing OOP and data structures using C++.' },
    { name: 'Photoshop', icon: <FaLaptopCode />, description: 'Designing and editing graphics using Adobe Photoshop.' },
    { name: 'After Effects', icon: <FaLaptopCode />, description: 'Creating motion graphics and visual effects.' },
    { name: 'Vuforia / ARKit / ARCore', icon: <FaLaptopCode />, description: 'Developing AR experiences with Vuforia, ARKit, and ARCore.' },
  ];
  ...
  const timeline = [
    ...
    },
    {
      year: '2022',
      title: 'Completed HSC',
      description: 'Finished Higher Secondary at SSM Lakshmi Ammal Mat Hr Sec School.',
      icon: <FaGraduationCap className="text-2xl text-blue-400" />,
    },
    {
      year: '2022',
      title: 'Joined B.E. in Computer Science and Design',
      description: 'Started undergraduate program at Kongu Engineering College, Erode.',
      icon: <FaGraduationCap className="text-2xl text-blue-400" />,
    },
    {
      year: '2023',
      title: 'Farmer ease UI/UX project',
      description: 'The Farmer Ease UI/UX project aims to design a seamless, intuitive interface that simplifies agricultural management tasks for farmers, enhancing productivity and ease of use..',
      icon: <FaProjectDiagram className="text-2xl text-blue-400" />,
    },
    {
      year: '2023',
      title: 'Developed AR Anatomy Scanner',
      description: 'Created an AR learning tool for students to visualize anatomical structures using Unity.',
      icon: <FaLaptopCode className="text-2xl text-blue-400" />,
    },
    {
       year: '2023',
      title: 'College Club Media Team',
      description: 'Managed and created digital content for club events, promotions, and social media as part of the College Club Media Team. (2023-2026)',
      icon: <FaProjectDiagram className="text-2xl text-blue-400" />,

    },
    {
      year: '2024',
      title: 'Won 3rd Prize in Project Expo',
      description: 'Recognized for developing an innovative AR application at a college expo.',
  ...
  initial="initial"
  className="w-[400px] h-[400px] rounded-full relative p-4"
  whileInView="visible"
  whileHover="hover"
  viewport={{ once: true, margin: '-100px' }}
>
  <div
    className={`relative overflow-hidden w-full h-full rounded-full transition-shadow duration-300 border
    ${theme === 'dark'
  ...
  >
    <img
      src="/assets/image/dharaneesh.png.jpeg"
      alt="Dharaneesh, UI/UX and AR/VR"
      className="object-cover w-full h-full rounded-full"
      loading="lazy"
    />

    <div
      className={`absolute inset-0 bg-gradient-to-t from-gray-900/80 to-transparent rounded-full
      ${theme === 'dark' ? 'from-gray-900/80' : 'from-gray-800/80'}`}
    />
    <div className="absolute bottom-6 left-1/2 transform -translate-x-1/2 text-gray-100 text-center">
  <p className="text-xl font-semibold">Dharaneesh</p>
  <p className="text-sm text-gray-300">UI/UX and AR/VR</p>
</div>
          ...
          >
            ...
            >
              <p>
                I’m Dharaneesh , a UI/UX and AR/VR passionate about building seamless, innovative digital solutions. From intuitive frontends to robust backends, I turn ideas into reality.
              </p>
              <p className="mt-4">
            ...
            >
              {[
                {
                                url: 'https://github.com/DharaneeshAN',
                                icon: <FaGithub className="text-2xl sm:text-3xl text-gray-200" />,
                                label: 'GitHub',
                              },
                              {
                                url: 'https://www.linkedin.com/in/dharaneesh-a-n-b43570259/', // Replace with your LinkedIn URL
                                icon: <FaLinkedin className="text-2xl sm:text-3xl text-gray-200" />,
                                label: 'LinkedIn',
                              },
                              {
                                url: 'https://www.instagram.com/dharanezzz/', // Replace with your Instagram URL
